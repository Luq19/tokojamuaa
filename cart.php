        ...
        <section class="py-5">
          ...
          <div class="row">
            <div class="col-lg-8 mb-4 mb-lg-0">
              <!-- jika blm ada barang yang ditambahkan ke keranjang/tidak ada session keranjang -->
              <?php  if(empty($_SESSION["keranjang"]) OR !isset($_SESSION["keranjang"])) :
              echo '<div class="alert alert-danger">Tidak ada produk dalam keranjang!.</div>';
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th class="pl-0 border-0" scope="row">
                        <div class="media align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.html"><img src="admin/foto_produk/<?= $pecah['foto_produk']; ?>" alt="..." width="70"/></a>
                          <div class="media-body ml-3"><strong class="h6"><a class="reset-anchor animsition-link" href="detail.html"><?= $pecah['nama_produk']; ?></a></strong></div>
                        </div>
                      </th>
                      <td class="align-middle border-0">
                        <p class="mb-0 small">Rp. <?= number_format($pecah['harga_produk']); ?></p>
                      </td>
                      <td class="align-middle border-0">
                        <div class="border d-flex align-items-center justify-content-between px-3"><span class="small text-uppercase text-gray headings-font-family">Quantity</span>
                          <div class="quantity">
                            <!-- <button class="dec-btn p-0"><i class="fas fa-caret-left"></i></button> -->
                            <input class="form-control form-control-sm border-0 shadow-0 p-0" type="text" value="<?= $jumlah ?>" readonly/>
                            <!-- <button class="inc-btn p-0"><i class="fas fa-caret-right"></i></button> -->
                          </div>
                        </div>
                      </td>
                      <td class="align-middle border-0">
                        <p class="mb-0 small">Rp. <?= number_format($subharga); ?></p>
                      </td>
                      <td class="align-middle border-0"><a class="reset-anchor" href="hapuskeranjang.php?id=<?= $id_produk; ?>"><i class="fas fa-trash-alt small text-muted"></i></a></td>
                    </tr>
                    <?php $total += $subharga; ?>
                    <?php endforeach; ?>
                  </tbody>
